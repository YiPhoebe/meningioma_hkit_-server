...
for bet_dir, phase in [(bet_dir_test, "test")]:
    gtv_clipping_stats = []
    bbox_stats = []
...
df.to_csv("/home/iujeong/brain_meningioma/outputs/csv/gtv_clipping_stats_test.csv", index=False)

# Bounding Box 저장
df_bbox = pd.DataFrame(all_bbox_stats)
df_bbox.to_csv("/home/iujeong/brain_meningioma/outputs/csv/bbox_stats_test.csv", index=False)
